...
description: Use when implementation is complete, all tests pass, and you need to decide how to integrate the work. Core principle: Verify tests → Present options → Execute choice → Clean up.
---
...
| Automatic worktree cleanup | Only cleanup for Options 1 & 4 |
