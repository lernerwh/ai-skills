...
- **切换到技能 requesting-code-review.md (使用 gskill requesting-code-review)** - Code review template for reviewer subagents
...
- **切换到技能 test-driven-development.md (使用 gskill test-driven-development)** - Subagents follow TDD for each task

**Alternative workflow:**
- **切换到技能 executing-plans.md (使用 gskill executing-plans)** - Use for parallel session instead of same-session execution
