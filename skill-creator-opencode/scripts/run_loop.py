...
overfitting. Works with multiple AI backends via ai_backend.py.
"""
...
from scripts.ai_backend import detect_backend
...
def run_loop(
    ...
    effective_backend = backend or detect_backend()
...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.4,
        help="Fraction of eval set to hold out for testing",
    )
    ...
    parser.add_argument(
        "--report", default="auto", help="Generate HTML report (auto/none/path)"
    )
    parser.add_argument(
        "--results-dir", default=None, help="Save all outputs to a subdirectory here"
    )
